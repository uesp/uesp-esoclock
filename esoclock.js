...
var GAMETIME_WEEKDAY_OFFSET = 4;				// Weekday offset to make launch day Fredas
//GAMETIME_WEEKDAY_OFFSET = 2;					// Fix to match time used in Clock v0.7.13 addon.
...
var DEFAULT_MOONPHASETIME = 30 * DEFAULT_REALSECONDSPERGAMEDAY;
var DEFAULT_MOONPHASESTARTTIME = 1435838770 + DEFAULT_MOONPHASETIME/2;	// 1436153095, Clock: 1435834841
...
function drawClock()
{
	$('#gameTime').html(computeGameTimeFromUTC(utcTime) + "<br /><font size='-0.5'>Moons are " + computeMoonPhase(utcTime) + "</font>");
